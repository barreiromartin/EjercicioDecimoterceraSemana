...
function __main__() {
    ...
    $(".enemigo").css({"color":"red","font-size":"16px","border-style":"solid","border-color":"black","text-align":"center","width":"49%","display":"inline-block","heigth":"10%"})
    
    
    
    var enemigo1 = new enemigo("Inés", 1000, 200, 1);
    $("#nivelEnemigo").html(enemigo1.getNivel);
    $("#saludEnemigo").html(enemigo1.getVida);
